...
class SupervisorNewStudentScreen extends StatefulWidget {
  const SupervisorNewStudentScreen({
    Key key,
    @required this.bloc,
...
class _AdminNewStudentScreenState extends State<SupervisorNewStudentScreen> {
