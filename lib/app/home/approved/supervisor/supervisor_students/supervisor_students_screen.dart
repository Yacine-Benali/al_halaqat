...
import 'package:alhalaqat/app/home/approved/supervisor/supervisor_students/supervisor_student_tile_widget.dart';
import 'package:alhalaqat/app/home/approved/supervisor/supervisor_students/supervisor_students_bloc.dart';
import 'package:alhalaqat/app/home/approved/supervisor/supervisor_students/supervisor_students_provider.dart';
...
class SupervisorStudentsScreen extends StatefulWidget {
  const SupervisorStudentsScreen._({
    Key key,
    @required this.bloc,
  ...
  static Widget create({
    ...
    User supervisor = Provider.of<User>(context, listen: false);
    Auth auth = Provider.of<Auth>(context, listen: false);

    SupervisorStudentsProvider provider =
        SupervisorStudentsProvider(database: database);

    SupervisorStudentsBloc bloc = SupervisorStudentsBloc(
      provider: provider,
      supervisor: supervisor,
      auth: auth,
    );

    return SupervisorStudentsScreen._(
      bloc: bloc,
      center: center,
    );
  }
...
class _AdminsStudentsScreenState extends State<SupervisorStudentsScreen> {
  SupervisorStudentsBloc get bloc => widget.bloc;
  ...
  Widget buildBody(List<Student> supervisorsList, List<Halaqa> halaqatList) {
    if (supervisorsList.isNotEmpty) {
      return _buildList(supervisorsList, halaqatList);
    } else {
      return EmptyContent(
        title: 'لا يوجد  ',
        message: '',
  ...
  Widget _buildList(List<Student> studentsList, List<Halaqa> halaqatList) {
    return SearchBar<Student>(
      ...
      buildSuggestion: (Student student, int index) {
        ...
        return SupervisorStudentTileWidget(
          bloc: bloc,
          chosenCenter: chosenCenter,
          chosenStudentState: chosenStudentState,
          scaffoldKey: _scaffoldKey,
